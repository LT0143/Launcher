...
//        public static void UnZip(string zipFilePath, string unZipDir,string passWord=null, MainWindow mainForm =null)
//        {
...
//                    {
//                        mainForm.m_maxZipSize += s.Length;
//                    }
//                }
//            }
//            using (var s = new ZipInputStream(File.OpenRead(zipFilePath)))
...
//                                if (size > 0)
//                                {
//                                    if (mainForm != null) mainForm.m_curZipSize += size;
...
//        }
        ...
        //public void UnZipForSoulOfWar(string zipFilePath, string unZipDir, string passWord, MainWindow mainForm)
        //{
        //    if (zipFilePath == string.Empty)
        //    {
        //        throw new Exception("压缩文件不能为空！");
